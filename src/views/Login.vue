    ...
    >
      ...
      >
        ...
        <router-link
          to="/"
          title="dini store"
          class="flex absolute text-xl ml-3 top-5 text-center cursor-pointer text-gray-100 focus:outline-none"
        >
          dini<span class="font-bold">store.</span>
        </router-link>
        <img
      ...
      <div
        class="md:flex md:items-center md:justify-center w-full sm:w-auto md:h-full lg:w-2/5 xl:w-2/5 p-8 md:p-10 lg:p-14 sm:rounded-lg md:rounded-none bg-white"
      >
        <div class="max-w-md w-full space-y-8">
          ...
          <div class="flex flex-row justify-center items-center space-x-3">
            <button
              @click="GoogleLogin"
              target="_blank"
              class="w-11 h-11 items-center justify-center text-red-600 inline-flex rounded-2xl font-bold text-lg shadow-md hover:shadow-lg cursor-pointer transition ease-in duration-300"
            >
              <font-awesome-icon icon="fa-brands fa-google" /></button
            ><button
              target="_blank"
              class="w-11 h-11 items-center justify-center inline-flex rounded-2xl font-bold text-xl text-white bg-blue-400 hover:shadow-lg cursor-pointer transition ease-in duration-300"
            >
              <img
                class="w-4 h-4 mt-1"
            ...
            ><button
              target="_blank"
              class="w-11 h-11 items-center justify-center inline-flex rounded-2xl font-bold text-xl text-white bg-blue-500 hover:shadow-lg cursor-pointer transition ease-in duration-300"
            >
